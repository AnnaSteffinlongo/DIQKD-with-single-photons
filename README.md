...
- Asymptotic_Key_rRte.jl imports State_Measurement_functions.jl and optimizes the parameters to compute CHSH and asymptotic key rate both as a function of noise (for fixed distance) and as a function of distance (for fixed noise). It is used to create the data for Fig.2 in the main text and all the Fig. in Supplemental Material Sec. C.
